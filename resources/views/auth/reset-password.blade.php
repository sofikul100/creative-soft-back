...
<head>
    ...
    <!-- Title -->
    <title>Creative Soft --||-- Reset-Password  </title>
    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                is-invalid
                @endif" id="email" name="email" :value="old('email', $request->email)" aria-describedby="email" required  placeholder="Enter Your Email">
                 <!------- error message show ---->
                ...
                <input type="password" required class="form-control @if ($errors->first('password'))
                is-invalid
