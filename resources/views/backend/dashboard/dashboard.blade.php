    ...
    <div class="content-wrapper">
        <div class="container">
                        ...
                        <div class="card-body">
                            <div class="widget-stats-container d-flex">
                                ...
                                <div class="widget-stats-content flex-fill">
                                    ...
                                    <span class="widget-stats-amount">{{$services}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card widget widget-stats">
                        <div class="card-body">
                            <div class="widget-stats-container d-flex">
                                ...
                                @endphp
                                <div class="widget-stats-content flex-fill">
                                    <span class="widget-stats-title">Total Projects</span>
                                    <span class="widget-stats-amount">{{$projects}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card widget widget-stats">
                        <div class="card-body">
                            <div class="widget-stats-container d-flex">
                                ...
                                @php
                                     $team_mumbers = App\Models\Team::all()->count();
                                @endphp
                                <div class="widget-stats-content flex-fill">
                                    <span class="widget-stats-title">Total Team Mumbers</span>
                                    <span class="widget-stats-amount">{{$team_mumbers}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card widget widget-stats">
                        <div class="card-body">
                            <div class="widget-stats-container d-flex">
                                ...
                                @php
                                     $slider_images = App\Models\Slider::all()->count();
                                @endphp
                                <div class="widget-stats-content flex-fill">
                                    <span class="widget-stats-title">Total Slider Images</span>
                                    <span class="widget-stats-amount">{{$slider_images}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card widget widget-stats">
                        <div class="card-body">
                            <div class="widget-stats-container d-flex">
                                ...
                                @php
                                     $client_says = App\Models\ClientSay::all()->count();
                                @endphp
                                <div class="widget-stats-content flex-fill">
                                    <span class="widget-stats-title">Total Client Says</span>
                                    <span class="widget-stats-amount">{{$client_says}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="widget-payment-request-container">
                                <div class="widget-payment-request-author">
                                    <div class="avatar m-r-sm">
                                        <img src="{{asset('backend/assets/images/avatars/avatar.png')}}" alt="">
                                    </div>
                                ...
                                <div class="widget-payment-request-product">
                                    <div class="widget-payment-request-product-image m-r-sm">
                                        <img src="{{asset('backend/assets/images/other/facebook_logo.png')}}" class="mt-auto" alt="">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget-popular-product-container">
                                <div class="widget-popular-product-image">
                                    <img src="{{asset('backend/assets/images/widgets/popular-product.jpeg')}}" alt="">
                                </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <img src="{{asset('backend/assets/images/widgets/blog5.jpeg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="widget-popular-blog-container">
                                <div class="widget-popular-blog-image">
                                    <img src="{{asset('backend/assets/images/widgets/product2.jpeg')}}" alt=""> 
                                </div>
